package com.acerem.musicplayerar
...
object GoConstants {
    ...
    const val PLAYLISTS_TAB = "PLAYLISTS_TAB"
    ...
    val DEFAULT_ACTIVE_FRAGMENTS =
        listOf(SONGS_TAB, ALBUM_TAB, PLAYLISTS_TAB, FOLDERS_TAB, SETTINGS_TAB)
